...
const SplashScreen = () => {
  ...
  return (
    ...
    >
      ...
      <h1
        ref={brandRef}
        className="splash_brand_name ml-4 mt-[-15px] uppercase text-purple-400 tracking-widest font-bold text-5xl"
      >
      ...
      >
        {
          ...
          <span key={index} className="quotes">
            {letter}
          </span>
        ))}
      </h2>
